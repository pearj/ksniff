...
func (d *ContainerdBridge) BuildTcpdumpCommand(containerId *string, netInterface string, filter string, pid *string, socketPath string, tcpdumpImage string, tcpdumpCrictlFlags string) []string {
    ...
    `, d.socketPath, tcpdumpCrictlFlags, tcpdumpImage, *containerId, tcpdumpImage, d.tcpdumpContainerName, tcpdumpCommand)
